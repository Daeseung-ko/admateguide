        ...
        ${state.bid === 'max' ? `
          <div style="margin-top:12px">
            <div class="sim-krw">
              ...
              <span class="sim-krw-suffix">1,000회 노출당</span>
            </div>
            <div class="sim-fdesc" style="margin:7px 0 0">1,000회 노출당 지불할 의사가 있는 최대 금액을 설정하세요.</div>
          </div>` : ''}
      </div>
      <div class="sim-field">
        ${flabel('게재 위치')}
