...
(function () {
  ...
  function secDelivery() {
    /* 판매 목표는 자동 입찰만 사용(입찰 전략 UI 없음) — 타 목표에서 넘어온 최대 입찰가 상태 방어 */
    if (state.bid === 'max') state.bid = 'auto';
    return sectionCard('delivery', '⚡', '전달 및 게재 위치', `
      <div class="sim-row">
        <div class="sim-field">
          ${flabel('최적화 목표')}
          <input class="sim-input" value="Website Conversions" readonly style="background:#fafaf9;color:#8c8880">
        </div>
        <div class="sim-field">
          ${flabel('결제 방법')}
